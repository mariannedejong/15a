...
//part 2
let kleuren = ["blauw", "rood", "groen"];
console.log (kleuren);
console.log(kleuren.length);
console.log(kleuren[0]);
console.log(kleuren[kleuren.length-1]);
let newLength = kleuren.push("geel");
console.log(kleuren);
let secondNewLength = kleuren.push(5);
console.log(kleuren);
let thirdNewLength = kleuren.push("{greeting: hi, i am an object}");
console.log (kleuren[kleuren.length-1]);
...
console.log ("Name cat breed 3: ", catBreeds[1].name);
...
let temperamentLengthCatBreed3 = catBreeds[2].temperament.length;
console.log ("Last temperament cat breed 3: ", catBreeds[2].temperament[temperamentLengthCatBreed3-1]);
